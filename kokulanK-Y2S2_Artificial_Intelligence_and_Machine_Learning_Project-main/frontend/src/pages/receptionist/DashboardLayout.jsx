...
export default function DashboardLayout({ children, activePage }) {
  ...
  const links = [
    ...
    { to: '/dashboard/receptionist/profile', icon: FaUser, label: 'Profile', key: 'profile' },
    { to: '/dashboard/receptionist/cleaning-tasks', icon: FaBroom, label: 'Cleaning Tasks', key: 'cleaning' }, // <-- new link
  ];
