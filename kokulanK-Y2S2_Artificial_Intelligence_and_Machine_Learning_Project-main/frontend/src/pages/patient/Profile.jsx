          ...
          <div className="px-6 py-5 flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs mt-0.5">Permanently delete your account and all your data. This action is irreversible.</p>
              </div>
            </div>
            <button
              onClick={() => setShowDeleteModal(true)}
              className="btn-danger-outline px-5 py-2.5 text-sm flex items-center gap-2"
            >
              <FaTrash className="text-xs" /> Delete Account
            </button>
          </div>
