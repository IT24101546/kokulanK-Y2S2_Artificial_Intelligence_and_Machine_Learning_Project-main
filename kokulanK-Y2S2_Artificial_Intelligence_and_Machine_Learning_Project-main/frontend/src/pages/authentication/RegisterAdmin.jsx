...
import { FaUserMd, FaEnvelope, FaLock, FaIdBadge } from "react-icons/fa";
...
const RegisterAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) navigate("/dashboard/admin");
  ...
  const styles = {
    ...
    passwordStrengthFill: {
      ...
      background: passwordStrength < 50 ? "#ff6b6b" : passwordStrength < 75 ? "#f1c40f" : "#2ecc71",
  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.card}>
        ...
        <h2 style={styles.headerText}>Register as Admin</h2>
